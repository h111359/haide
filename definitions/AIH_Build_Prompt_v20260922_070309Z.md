...
Prompt version: 20260922_070309Z
Generated (UTC): 2026-09-22 07:03:09Z
...
7. **Settings**: agent profiles, defaults and capability assignments, compatibility/authentication diagnostics, skills, supported declarative product settings, and a human-editable custom-instructions area. Keep privileged executable/permission settings distinct from ordinary content. Only deliberate human edits may change custom instructions; agent suggestions belong in outputs. State when settings will take effect and preserve active-process boundaries.
...
Deliver the working core, conventions/templates, standalone skills, Python CLI and shared menu, optional Windows/Linux launchers, the complete portal, tests, demonstration fixtures, `.aih/README.md`, and `.aih/USER_GUIDE.md` with shared menu/portal help.
